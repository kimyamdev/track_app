...
def units_summary(tx_df, date_range, hist_ptf_df):
  ...
  portfolio_units.loc[:, "Cash_Move"] = pd.to_numeric(portfolio_units["Quantity"])
  portfolio_units.loc[:, "Cash_Move_SGD"] = portfolio_units['FX'] * portfolio_units['Cash_Move']
  portfolio_units.loc[:, "Cash_Move_SGD"] = portfolio_units["Cash_Move_SGD"].fillna(0)
